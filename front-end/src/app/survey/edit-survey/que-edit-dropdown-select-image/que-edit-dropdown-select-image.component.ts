...
@Component({
  selector: 'app-que-edit-dropdown-select-image',
  templateUrl: './que-edit-dropdown-select-image.component.html',
  styleUrls: ['./que-edit-dropdown-select-image.component.css']
})
export class QueEditDropdownSelectImageComponent implements OnInit {
